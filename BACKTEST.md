...
as *Not applicable* and leaves the coverage denominator entirely, because it is not an obligation that can
...
| Unit slip | Caught, and named: *"Figures differ by exactly 100 times, which looks like a lakh entered where crore was expected"* |
...
work by the promoter closes them. They are still surfaced, because they are on the critical path and are
